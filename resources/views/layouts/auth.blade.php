...
<head>
    <base href="../../../../">
    <meta charset="utf-8"/>
    <title>Brilliant Sanitary | Forgot Password</title>
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-3 wizard d-flex flex-column flex-lg-row flex-column-fluid">
        <!--begin::Aside-->
        <div class="login-aside bg-dark d-flex flex-column flex-row-auto">
            <!--begin::Aside Top-->
            <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                <!--begin::Aside Header-->
                <a href="#" class="login-logo text-center pt-lg-25 pb-10">
                    <img src="{{asset('assets/media/logos/brilliant.png')}}" class="max-h-70px" alt=""/>
                </a>
                <!--end::Aside Header-->
